...
#create table ( 'CID, TH Fullname,EN Fullname, Date of Birth, Gender,
#Card Issuer, Issue Date, Expire Date, Address, Disease, Drug Allergy

#if 'ID' not exist in table
compare = cursor.execute("SELECT cid FROM IDs WHERE cid=(?)", (cid))    
if(compare < 10):
    print('xd')
    #add row 'ID' to table
    ##go to switch
...
#print row 'ID'
#input'n' 1 or 2
    #if n = 1 ; Disease = input
        ##go to switch
    #if n = 2 ; Drug Allergy = input
        ##go to switch
